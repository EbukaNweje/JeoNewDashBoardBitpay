...
const NewWithdrawal = () => {
  ...
  const url = `https://new-joe-back2025.vercel.app/api/requestwithdrawcode/${id}`;
  const urlll = `https://new-joe-back2025.vercel.app/api/withdraw/${id}`;
  const urlprofit = `https://new-joe-back2025.vercel.app/api/transferprofittoaccount/${id}`;
  const urlemail = `https://new-joe-back2025.vercel.app/api/withdrawalemailsend/${id}`;
  ...
  const sendWallet = () => {
    ...
    axios
      .post(urlll, datas)
      .then((res) => {
        console.log(res), sendSignUpEmail();
      ...
      >
        <div className="w-full h-max flex flex-col items-center justify-center gap-4 p-4">
          ...
          <p className="w-full text-center ">
            ...
            BTC) using {wallet} Payment. Please cancel if you did not initiate
            the transaction.
          </p>
          <button
            className="w-max h-max px-5 py-2 rounded text-white font-semibold bg-[#a286f4]"
          ...
          <p className="w-full text-center ">
            This transaction will appear on your wallet statement as Deposit.
          </p>
          <button
