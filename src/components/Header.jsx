...
const Header = () => {
  ...
  const handleGetUser = async () => {
    setLoading(true);
    await axios
      .get(`https://new-joe-back2025.vercel.app/api/userdata/${id}`)
      .then((response) => {
        setLoading(false);
            ...
            <div className="w-max h-full flex gap-2 text-white phone:hidden">
              ...
              <div className="w-max h-full border-t-[3px] px-4 border-t-[#a287f4] flex items-center font-semibold">
                ...
                >
                  ...
                  >
                    <NavLink to={"/dashboard/new-withdrawal"}>
              ...
              <div className="w-max h-full border-t-[3px] px-4 border-t-[#a287f4] flex items-center font-semibold">
                ...
                >
                  ...
                  >
                    ...
                    <NavLink to={"/dashboard/my-withdrawal"}>
                      <div className="w-full pl-2 text-gray-600 h-10  flex items-center cursor-pointer">
                        Withdrawal
                      </div>
                    </NavLink>
                    <NavLink to={"/dashboard/profit"}>
                      <div className="w-full pl-2 text-gray-600 h-10  flex items-center cursor-pointer">
                        Profit
                      </div>
                    </NavLink>
            ...
            >
              <div className="w-full h-max flex gap-2 items-center justify-center pl-4 py-5 border-t-[3px] rounded-t border-t-[#a287f4]">
                ...
                <NavLink to={"/dashboard/profile"}>
                  <div className="w-max">
                    <CiSettings size={20} className="text-[#364a63]" />
                  </div>
                </NavLink>
              </div>
              ...
              <div className="w-full h-max flex flex-col gap-4 justify-center pl-8 py-5 border-t border-t-gray-300 text-[#526484]">
                ...
                <NavLink to={"/dashboard/profile"}>
                  <div className="w-full h-8 flex items-center hover:text-[#a287f4] cursor-pointer transition-all duration-500 gap-2">
                    <FaRegUser size={17} />
                    <p className="text-sm">Account Setting</p>
                  </div>
                </NavLink>
                  ...
                  <div className="w-full h-max flex flex-col gap-3" key={i}>
                    <div className="w-full h-max flex flex-col  gap-1">
                      <p className="w-[100%] text-[ #364a63] text-l w-max flex justify-between gap-5 items-center font-semibold">
                        <p
                          className="w-max h-max flex justify-end bg-[red] text-[white] text-xs	font-size: 0.85rem; "
                          style={{
                            padding: "4px",
                          }}
                        >
                      ...
                      <p className="w-[100%] text-[ #364a63] text-m	font-size: 0.95rem;">
                        {" "}
                        STARTER PLAN
                      </p>
                      <div className="w-full flex flex-col gap-2">
                        ...
                        <p className="w-1/2 h-max flex items-center gap-2 text-1xl text-[#526484] text-xs	font-size: 0.75rem;">
                          30
                          <span className="text-1x1 text-[#8094ae]">Days</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <button className="w-full h-max py-3 text-xs font-semibold rounded text-[#ffff] bg-[#a286f4] border border-gray-300 hover:bg-[#bca6fd] hover:border-[#cfd4e3] hover:text-[#ffff] transition-all duration-200">
                      CHOOSE THIS PLAN
                    </button>
                  </div>
                ))
              ) : (
                <span className="text-xs font-semibold rounded text-[grey]">
                  {" "}
